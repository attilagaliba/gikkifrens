...
export default function RootLayout({
  ...
  const earlyList = {
    values: [
      ...
      427685, 17474, 278653, 4549, 239709, 268992, 277700, 320189, 408746,
      237778, 395461, 576740, 253127, 403619, 12021, 296785, 269385, 2904,
      382254, 449282, 214570, 409852, 351282, 263685, 488644, 2904,
    ],
  };
